...
describe('Routes Tests GET /api/v1/work/:providerId', () => {
  ...
  test('Testing for update work /api/v1/work/1 and get status 200', (done) => {
    supertest(app)
      .patch('/api/v1/work/10')
  ...
  test('Testing for update work /api/v1/work/1 and get status 401 UnAuthorized', (done) => {
    supertest(app)
      .patch('/api/v1/work/1')
      .set('Cookie', [`token= ${process.env.TOKEN}`])
      .expect(401)
